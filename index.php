                ...
                <div class="flex items-center gap-2 flex-wrap">
                    ...
                    <div class="relative inline-block text-left">
                        ...
                        <div id="batchMenuDropdown" class="hidden absolute right-0 mt-1.5 w-56 rounded-lg bg-[#161b22] border border-[#30363d] shadow-xl z-20 py-1 text-xs">
                            <button onclick="window.copyAllVisibleHttps()" class="w-full text-left px-4 py-2.5 text-[#e6edf3] hover:bg-[#21262d] flex items-center gap-2">
                                <svg class="w-4 h-4 text-[#58a6ff]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg>
                    ...
                    <div class="flex items-center bg-[#0d1117] border border-[#30363d] rounded-lg p-0.5">
                        <button id="viewModeGrid" class="p-1.5 rounded-md bg-[#30363d] text-white transition" title="Grid View">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>
                        </button>
                        <button id="viewModeList" class="p-1.5 rounded-md text-[#8b949e] hover:text-white transition" title="Compact Table View">
